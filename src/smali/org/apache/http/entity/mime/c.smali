.class public final Lorg/apache/http/entity/mime/c;
...
.field private final g:Lorg/apache/http/entity/mime/HttpMultipartMode;
...
.method public constructor <init>(Ljava/lang/String;Ljava/nio/charset/Charset;Ljava/lang/String;Lorg/apache/http/entity/mime/HttpMultipartMode;)V
    ...
    :goto_0
    iput-object p2, p0, Lorg/apache/http/entity/mime/c;->d:Ljava/nio/charset/Charset;

    iput-object p3, p0, Lorg/apache/http/entity/mime/c;->e:Ljava/lang/String;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lorg/apache/http/entity/mime/c;->f:Ljava/util/List;

    iput-object p4, p0, Lorg/apache/http/entity/mime/c;->g:Lorg/apache/http/entity/mime/HttpMultipartMode;
...
.method private a(Lorg/apache/http/entity/mime/HttpMultipartMode;Ljava/io/OutputStream;Z)V
    ...
    iget-object v0, p0, Lorg/apache/http/entity/mime/c;->d:Ljava/nio/charset/Charset;

    iget-object v1, p0, Lorg/apache/http/entity/mime/c;->e:Ljava/lang/String;

    invoke-static {v0, v1}, Lorg/apache/http/entity/mime/c;->a(Ljava/nio/charset/Charset;Ljava/lang/String;)Lorg/apache/http/util/ByteArrayBuffer;

    move-result-object v2

    iget-object v0, p0, Lorg/apache/http/entity/mime/c;->f:Ljava/util/List;
    ...
    invoke-virtual {v1}, Lorg/apache/http/entity/mime/a;->b()Lorg/apache/http/entity/mime/b;

    move-result-object v0

    sget-object v4, Lorg/apache/http/entity/mime/d;->a:[I
    ...
    invoke-virtual {v1}, Lorg/apache/http/entity/mime/a;->a()Lorg/apache/http/entity/mime/a/a;

    move-result-object v0

    invoke-virtual {v0, p2}, Lorg/apache/http/entity/mime/a/a;->a(Ljava/io/OutputStream;)V
    ...
    :pswitch_0
    invoke-virtual {v0}, Lorg/apache/http/entity/mime/b;->iterator()Ljava/util/Iterator;
    ...
    check-cast v0, Lorg/apache/http/entity/mime/e;

    invoke-virtual {v0}, Lorg/apache/http/entity/mime/e;->a()Ljava/lang/String;

    move-result-object v5

    invoke-static {v5, p2}, Lorg/apache/http/entity/mime/c;->a(Ljava/lang/String;Ljava/io/OutputStream;)V

    sget-object v5, Lorg/apache/http/entity/mime/c;->a:Lorg/apache/http/util/ByteArrayBuffer;

    invoke-static {v5, p2}, Lorg/apache/http/entity/mime/c;->a(Lorg/apache/http/util/ByteArrayBuffer;Ljava/io/OutputStream;)V

    invoke-virtual {v0}, Lorg/apache/http/entity/mime/e;->b()Ljava/lang/String;

    move-result-object v0

    invoke-static {v0, p2}, Lorg/apache/http/entity/mime/c;->a(Ljava/lang/String;Ljava/io/OutputStream;)V
    ...
    invoke-virtual {v0, v4}, Lorg/apache/http/entity/mime/b;->a(Ljava/lang/String;)Lorg/apache/http/entity/mime/e;

    move-result-object v0

    iget-object v4, p0, Lorg/apache/http/entity/mime/c;->d:Ljava/nio/charset/Charset;

    invoke-static {v0, v4, p2}, Lorg/apache/http/entity/mime/c;->a(Lorg/apache/http/entity/mime/e;Ljava/nio/charset/Charset;Ljava/io/OutputStream;)V

    invoke-virtual {v1}, Lorg/apache/http/entity/mime/a;->a()Lorg/apache/http/entity/mime/a/a;

    move-result-object v0

    invoke-virtual {v0}, Lorg/apache/http/entity/mime/a/a;->e()Ljava/lang/String;
...
.method public final a(Ljava/io/OutputStream;)V
    ...
    iget-object v0, p0, Lorg/apache/http/entity/mime/c;->g:Lorg/apache/http/entity/mime/HttpMultipartMode;
...
.method public final a(Lorg/apache/http/entity/mime/a;)V
    .locals 1
...
.method public final b()J
    ...
    :try_start_0
    iget-object v3, p0, Lorg/apache/http/entity/mime/c;->g:Lorg/apache/http/entity/mime/HttpMultipartMode;

    const/4 v4, 0x0

    invoke-direct {p0, v3, v0, v4}, Lorg/apache/http/entity/mime/c;->a(Lorg/apache/http/entity/mime/HttpMultipartMode;Ljava/io/OutputStream;Z)V
